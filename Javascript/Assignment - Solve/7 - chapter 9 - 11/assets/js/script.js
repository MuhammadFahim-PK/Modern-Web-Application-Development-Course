...
var userGender = prompt("Enter you Gender, Male / Female.");
document.write("var userGender = prompt('Enter you Gender, Male / Female');<br><br>");
console.log("var userGender = prompt('Enter you Gender, Male / Female');");
